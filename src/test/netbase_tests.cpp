...
{
    BOOST_CHECK(TestSplitHost("www.matrixcoin.org", "www.matrixcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.matrixcoin.org]", "www.matrixcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.matrixcoin.org:80", "www.matrixcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.matrixcoin.org]:80", "www.matrixcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11071", "127.0.0.1", 11071));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11071", "127.0.0.1", 11071));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11071", "::ffff:127.0.0.1", 11071));
    BOOST_CHECK(TestSplitHost("[::]:11071", "::", 11071));
    BOOST_CHECK(TestSplitHost("::11071", "::11071", -1));
    BOOST_CHECK(TestSplitHost(":11071", "", 11071));
    BOOST_CHECK(TestSplitHost("[]:11071", "", 11071));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11071", "127.0.0.1:11071"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11071", "[::]:11071"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
