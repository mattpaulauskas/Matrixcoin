...
uint256 hashGenesisBlock("0x000000005b89b85b72512b0f3501b163e457a15107b8950707650dd8b75a7c21");
...
static const int64 nTargetTimespan = 6600;
...
void ThreadScriptCheck() {
    RenameThread("matrixcoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000005b89b85b72512b0f3501b163e457a15107b8950707650dd8b75a7c21");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04DAF1B7215DEE193EE2320B77A670D42E329B247CAD376A9AA85EEDB72E2C12C4A95CD35EE5160C9B16528686EFE6C8F27D90CC3C87EB4ADDD2056F8174AF5BA1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1396395808;
        block.nBits    = 486604799;
        block.nNonce   = 591705943;
        ...
        assert(block.hashMerkleRoot == uint256("0x58842a752c44f103228e1e29344f7a42d527d73c1ee6232cbbdc581a231209dd"));
		block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MatrixcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MatrixcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static MatrixcoinMiner(CWallet *pwallet)
{
    printf("MatrixcoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MatrixcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MatrixcoinMiner terminated\n");
        throw;
    }
}

void GenerateMatrixcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MatrixcoinMiner, pwallet));
}
