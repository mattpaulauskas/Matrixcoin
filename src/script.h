...
#ifndef H_MATRIXCOIN_SCRIPT
#define H_MATRIXCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMatrixcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Matrixcoin always counted CHECKMULTISIGs
